package com.cts.forex.skeleton;
...
public class SkeletonValidator {
	...
	public SkeletonValidator() {
		...
		validateClassName("com.cts.forex.dao.ForexCardDAO");
		validateClassName("com.cts.forex.dao.DBConnectionManager");
		validateClassName("com.cts.forex.model.ForexCardPyt");
		validateClassName("com.cts.forex.service.ForexCardPaymentService");
		validateClassName("com.cts.forex.exception.ForexCardPaymentException");
		validateClassName("com.cts.forex.util.ApplicationUtil");
		//----
		validateMethodSignature("buildForexCardPaymentList:ArrayList,addForexCardPytDetails:boolean,calculateDiscountedPayableAmt:double","com.cts.forex.service.ForexCardPaymentService");
		validateMethodSignature("insertForexCardPyt:boolean","com.cts.forex.dao.ForexCardDAO");
